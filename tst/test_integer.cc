...
TEST(IntegerTests, SUB_ZZ_Z_Integers_Lim){
   ...
   Integer r3("-40");
   EXPECT_EQ(r1.COM_NN_D(asb), 0);
   EXPECT_EQ(r2.COM_NN_D(asa), 0);
   EXPECT_EQ(r2.COM_NN_D(bsb), 0);
   EXPECT_EQ(r3.COM_NN_D(bsa), 0);
}
...
TEST(IntegerTests, DIV_ZZ_Z_Integers){
    ...
    EXPECT_EQ(r1.COM_NN_D(atb), 0);
    EXPECT_EQ(r2.COM_NN_D(atd), 0);
    EXPECT_EQ(r3.COM_NN_D(ctb), 0);
    EXPECT_EQ(r4.COM_NN_D(ctd), 0);
}
